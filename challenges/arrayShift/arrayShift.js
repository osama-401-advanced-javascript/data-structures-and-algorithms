...
console.log(ShiftArray(arr1, 5, cb));
console.log(ShiftArray(arr1, 99, cb));
console.log(ShiftArray(arr2, 16, cb));
console.log(ShiftArray(arr2, -100, cb));


function ShiftArray(arr, num, cb) {
